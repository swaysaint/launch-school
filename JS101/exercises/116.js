...
// separated by a hypne ('-'). For example, the array ['pig', 'pie', 'lie',
...
// ANSWER
// There is a missing semi colon after let ladder = '', which means the
// following code is evaluated as part of the ladder statement.